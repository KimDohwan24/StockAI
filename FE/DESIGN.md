...
colors:
  ...
  # Stock Market Specific (KR Style)
  market-up: "#e41e3f"        # Red for KR Market
  market-down: "#0064e0"      # Blue for KR Market
  market-neutral: "#8595a4"
  market-up-soft: "rgba(228, 30, 63, 0.1)"
  market-down-soft: "rgba(0, 100, 224, 0.1)"

  # Chart Tokens
  chart-grid: "#dee3e9"
  chart-label: "#8595a4"
  chart-crosshair: "#1c1e21"
...
components:
  ...
  card-stock-ticker:
    ...
    border: "1px solid {colors.hairline-soft}"
  card-recommendation-hero:
    backgroundColor: "{colors.canvas}"
    rounded: "{rounded.xxxl}"
    padding: "{spacing.xxl}"
    border: "1px solid {colors.hairline-soft}"
    shadow: "rgba(0, 100, 224, 0.08) 0px 20px 40px 0px"
  chart-container:
    backgroundColor: "{colors.canvas}"
    rounded: "{rounded.xxl}"
    padding: "{spacing.base}"
